...
export default function LoginScreen() {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: 'url(https://blob.caffeine.ai/v1/blob/?blob_hash=sha256%3Ac922d63f8271822d4f882642444f8f2bdb0d1941683fa577854ba343e6b0ce7d&owner_id=bjzp7-xyaaa-aaaaf-qbsta-cai&project_id=0198d89b-d4eb-711d-abfd-9b50202a1152)'
      }}
    >
      ...
      <Card className="relative z-10 w-full max-w-md backdrop-blur-sm bg-background/95 shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Welcome to Somers Scheduler</CardTitle>
          <CardDescription>
