...
import type { Availability as _Availability, ExternalBlob as _ExternalBlob, T as _T, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getRecentMessages(arg0: bigint): Promise<Array<[Principal, string, bigint]>> {
        if (this.processError) {
            try {
...
function from_candid_Availability_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Availability): Availability {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Availability]): Availability | null {
    return value.length === 0 ? null : from_candid_Availability_n18(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_T]): T | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        customProfilePicture: record_opt_to_undefined(await from_candid_opt_n15(_uploadFile, _downloadFile, value.customProfilePicture))
    };
}
...
async function from_candid_tuple_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _UserProfile, bigint]): Promise<[Principal, UserProfile, bigint]> {
    return [
        value[0],
        await from_candid_UserProfile_n13(_uploadFile, _downloadFile, value[1]),
        value[2]
    ];
}
function from_candid_tuple_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _Availability]): [Principal, Availability] {
    return [
        value[0],
        from_candid_Availability_n18(_uploadFile, _downloadFile, value[1])
    ];
}
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, _UserProfile, bigint]>): Promise<Array<[Principal, UserProfile, bigint]>> {
    return await Promise.all(value.map(async (x)=>await from_candid_tuple_n12(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, _Availability]>): Array<[Principal, Availability]> {
...
async function to_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        customProfilePicture: value.customProfilePicture ? candid_some(await to_candid_ExternalBlob_n29(_uploadFile, _downloadFile, value.customProfilePicture)) : candid_none()
    };
}
